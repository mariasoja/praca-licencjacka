...
$$
$\implies$
Załóżmy, że dla dow $\phi \in \Phi$, $\overline{\alpha}$, $\overline{\beta} \in \domkniecie{a}$ o ile $\overline{\alpha}, \overline{\beta}, \phi(\overline{\alpha}), \domkniecie{\phi}(\overline{\beta}) \in \mathcal{D}$ to mamy.
\begin{equation}
\mathcal{F}(\domkniecie{\phi}(\overline{\alpha}))=\mathcal{F}(\domkniecie{\phi}(\overline{\beta})) \iff \mathcal{F}(\overline{\alpha})=\mathcal{F}(\overline{\beta}).
\end{equation}
