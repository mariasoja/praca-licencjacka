...
\begin{definition}
Niech $U=\tuple{A,M,a,\Phi}$ będzie NAS niech $\mathcal{F}$ będzie uogólnioną funkcją rzeczywistą z dziedziną $\mathcal{D}$, i niech $F$ będzie uogólnioną operacją na pomiarach odpowiadających $\mathcal{F}$. Wtedy:
\begin{enumerate}
\item
$F$ jest bezwzględnie niezmienna względem $U$ wtedy i tylko wtedy, gdy dla każdego $m_{1}, m_{2} \in M$ i $\textbf{x} \in \domkniecie{A}$ takich, że $m_{1}(\textbf{x})$ oraz $m_{2}(\textbf{x})$ nalezą do $\mathcal{D}$,
\begin{equation*}
F(m_{1};\textbf{x})=F(m_{2};\textbf{x}).
\end{equation*}
\item
$F$ jest niezmiennym odniesieniem względem $U$ wtedy i tylko wtedy, gdy dla każdego $m_{1}, m_{2} \in M$ z ,$x \in A$ $\textbf{x} \in \domkniecie{A}$ takich, że $m_{1}(\textbf{x})$ oraz $m_{2}(\textbf{x})$ nalezą do $\mathcal{D}$,
\begin{equation*}
m_{1}(\textbf{x})=F(m_{1};\textbf{x})
\end{equation*}
 wtedy i tylko wtedy, gdy
\begin{equation*}
m_{2}(\textbf{x})=F(m_{2};\textbf{x})
\end{equation*}
\item
$F$ jest porównawczo niezmienna względem $U$ wtedy i tylko wtedy, gdy dla każdego ${m_{1}, m_{2} \in M$ i $\textbf{x}$,$\textbf{y} \in \domkniecie{A}$ takich, że $m_{1}(\textbf{x}), m_{2}(\textbf{x}), m_{1}(\textbf{y})$ oraz $m_{2}(\textbf{y})$ nalezą do $\mathcal{D}$,
\begin{equation*}
F(m_{1};\textbf{x})=F(m_{1};\textbf{y})
\end{equation*}
wtedy i tylko wtedy, gdy
\begin{equation*}
F(m_{2};\textbf{x})=F(m_{2};\textbf{y}).
\end{equation*}
\end{enumerate} 
\end{definition}
...
\begin{tw}
Niech $U=\tuple{A,M,a,\Phi}$ będzie regularnym numerical assignment systen, niech $\mathcal{F}$ będzie uogólnioną funkcją rzeczywistą z dziedziną $\mathcal{D}$ i niech $F$ będzie uogólnioną operacją na pomiarach odpowiadającą $\mathcal{F}$. Wtedy:
\begin{enumerate}
\item
Poniższe trzy warunki są równoważne.
\begin{enumerate}
\item
$F$ jest niezmienna bezwzględnie w stosunku do $U$ 
\item
Dla wszystkich $m \in M$,$\phi \in \Phi$ i $\textbf{x} \in \domkniecie{A}$ takie, że $m(\textbf{x})$ i $\phi(m(\textbf{x}))$ są w $\mathcal{D}$,
\begin{equation*}
\mathcal{F}(\phi(m(\textbf{x})))=\mathcal{F}(m(\textbf{x})).
\end{equation*}
\item
Dla wszystkich $\phi \in \Phi$ i $\alpha \in \domkniecie{a}$ takie, że $\alpha$ i $\phi(\alpha)$ są w $\mathcal{D}$,
\begin{equation*}
\mathcal{F}(\phi(\alpha))=\mathcal{F}(\alpha).
\end{equation*}
\end{enumerate}
\item
Poniższe trzy warunki są równoważne.
\begin{enumerate}
\item
$F$ jest referencyjna niezmiennie w stosunku do $U$
\item
Dla wszystkich $m \in M$,$\phi \in \Phi$,$x \in A$ i $\textbf{x} \in \domkniecie{A}$ takie, że $m(\textbf{x})$ i $\phi(m(\textbf{x}))$ są w $\mathcal{D}$,
\begin{equation*}
\mathcal{F}(\phi(m(x)))=\mathcal{F}(m(\textbf{x})).
\end{equation*}
\item
Dla wszystkich $\phi \in \Phi$, $\alpha \in a$ i $\alpha \in \domkniecie{a}$ takie, że $\alpha$ i $\phi(\alpha)$ są w $\mathcal{D}$,
\begin{equation*}
\mathcal{F}(\phi(\alpha))=\mathcal{F}(\alpha) \iff \alpha=\mathcal{F}(\alpha).
\end{equation*}
\end{enumerate}
\item
Poniższe trzy warunki są równoważne.
...
\item
Dla wszystkich $m \in M$,$\phi \in \Phi$ i $\textbf{x},\textbf{y} \in \domkniecie{A}$ takie, że $m(\textbf{x}),m(\textbf{y}$ i $\phi(m(\textbf{x}))$ i $\phi(m(\textbf{y}))$ są w $\mathcal{D}$,
\begin{equation*}
\mathcal{F}(\phi(m(x)))=\mathcal{F}(m(\textbf{y})) \iff \mathcal{F}(m(\textbf{x}))=\mathcal{F}(m(\textbf{y})).
\end{equation*}
\item
Dla wszystkich $\phi \in \Phi$, $\alpha, \beta \in \domkniecie{a}$  takie, że $\alpha, \beta, \phi(\alpha)$ i $\phi(\beta)$ są w $\mathcal{D}$,
\begin{equation*}
\mathcal{F}(\phi(\alpha))=\mathcal{F}(\phi(\beta)) \iff \mathcal{F}(\alpha)=\mathcal{F}(\beta).
\end{equation*}
\end{enumerate}
\end{enumerate}
\end{tw}
...
\begin{enumerate}
\item
$F$ jest bezwzględnie niezmienna w stosunku do $U$ wtedy i tylko wtedy gdy dla wszystkich $\phi \in \Phi$ i $\alpha \in \domkniecie{a}$ takie, że $\alpha$ i $\phi(\alpha)$ są w $\mathcal{D}$,
\begin{equation*}
\mathcal{F}(\phi(\alpha))=\mathcal{F}(\alpha).
\end{equation*}
\item
...
\end{equation*}
\item
$F$ jest porównawczo niezmienna w stosunku do $U$ wtedy i tylko wtedy gdy dla wszystkich $\phi \in \Phi$ istnieje funkcja $\psi_{\phi}$ taka, że dla wszystkich $\alpha \in \domkniecie{a}$ dla której $\alpha$ i $\phi(\alpha)$ są w $\mathcal{D}$,
\begin{equation*}
\mathcal{F}(\phi(\alpha))=\psi_{\phi}(\mathcal{F}(\alpha)).
\end{equation*}
\end{enumerate}
\end{tw}
